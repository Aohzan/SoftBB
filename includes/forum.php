		...
		while ($data = mysql_fetch_assoc($req)) 
		{
			...
			<tr>
				...
				/// FIN SESSION LU/PAS LU
				    ...
				    <td width="150" class="cadre_fonce_end" align="center" style="padding:3px">'.datefct($data['tmppost'],$gmt).'<br />par <a href="index.php?page=affprofil&amp;id='.$data['pseudodernier'].'">'.htmlentities($data['pseudoreponder']).'</a>
<a href="redir_last_post_list.php?post='.$data['id2'].'"><img src="img/statut/icon_latest_reply.gif" border="0" /></a></td>
				</tr>
			';
			}// Fin while
			echo'</table>';
