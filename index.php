...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	...
	<tr class="fond">
		...
		<td height="132"><a href="index.php?page=indexforum" tabindex="5"><img src="./img/menu/logo.gif" alt="Logo" /></a></td>
	...
	<tr>
		<td id="menu" height="55" colspan="2" align="left">
		<?php 
		if(empty($pseudo))
		{
			echo '<a href="index.php?page=connexion" tabindex="10"><img src="./img/menu/connexion.gif" alt="Connexion" /></a><a href="index.php?page=reg" tabindex="20"><img src="./img/menu/reg.gif" alt="S\'enregistrer" /></a>';
		}
		else
		{
			echo '<a href="index.php?page=lgout" tabindex="10"><img src="./img/menu/deconnexion.gif" alt="" /></a><a href="index.php?page=mp" tabindex="20"><img src="./img/menu/messagerie.gif" alt="Messagerie" /></a>';
		}
		?><a href="<?php if(!empty($pseudo)) { echo'index.php?page=profil'; } else { echo'index.php?page=connexion'; }?>" tabindex="30"><img src="./img/menu/profil.gif" alt="Profil" /></a><a href="index.php?page=membre" tabindex="40"><img src="./img/menu/membres.gif" alt="Membres" /></a><a href="index.php?page=groupe" tabindex="50"><img src="./img/menu/groupes.gif" alt="Groupes" /></a><a href="index.php?page=search" tabindex="60"><img src="./img/menu/recherche.gif" alt="Recherche" /></a><a href="index.php?page=faq" tabindex="70"><img src="./img/menu/faq.gif" alt="FAQ" /></a>
		</td>
	</tr>
	<tr>
		<!-- Forums -->
		<td colspan="2" bgcolor="#FFFFFF">
			...
			<table width="100%" class="texte_base_gras" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td height="29" class="titreforumend" colspan="2" style="padding-left:8px">Qui est en ligne ?</td>
				</tr>
				<tr class="texte_base_gras">
					...
					<td class="cadre1" style="padding-left:10px">
						...
						Code de couleur : <span class="admin">[ Administrateur ]</span> <span class="modo">[ Mod&eacute;rateur ]</span><br />
						...
						for($j=0; $j<$i;$j++)
						{
							...
							elseif($listerang[$j] == "1" || $listerang[$j] == "3")
							{
...
<p align="center" class="footer"><a href="http://www.softbb.net"><span class="footer">[ Copyright SoftBB v0.1.3 (mods) ]</span></a> , [ Par Atapi ] , [ <?php echo $requse; ?> Requ&ecirc;te<?php if($requse > 1) echo 's'; ?> mysql utilisée<?php if($requse > 1) echo 's'; ?> ] , [ GZIP <?php if($gzip) echo 'activé'; else echo 'désactivé'; ?> ] <?php
$mtime = explode(" ",microtime());
$endtime = $mtime[1] + $mtime[0];
echo ' , [ Page générée en ',number_format($endtime-$starttime,4,',',''),'s ]';
if($rang == 2) echo '<a href="admin/"><span class="footer"> , [ Administration ]</span></a>'; ?></p>
</body>
</html>
